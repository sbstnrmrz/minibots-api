# socket.io implementation — DISABLED in favour of HTTP POST /chat/message
# To re-enable:
#   1. Uncomment everything below
#   2. Uncomment the import and mount lines in app/main.py
#   3. Remove or disable app/routers/chat.py
